 ...
 * 
 */
@WebServiceClient(name = "WorkflowSearching", targetNamespace = "http://pad.polito.it/ws/Workflow/", wsdlLocation = "http://localhost:7081/wfinfo?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:7081/wfinfo?wsdl");
